...
import { useInView } from "react-intersection-observer";
 ...
 export default function About(){
  const {ref, inView} = useInView({duration:0.8, once:false})
      return(
          <div className="sm:max-w-[1050px] mx-auto md:mx-20 px-4 text-justify text-white-100 relative z-30">
         <section >
        <motion.h1 
         ref={ref}
         ...
         className="text-5xl font-bold py-10 pl-2">
        ...
        className="text:[5px]   text-justify  font-light leading-relaxed  sm:max-w-4xl sm:text-lg">
